...
export class ConsultaCrmProvider extends ProfessionalRegistryProvider {
  ...
  async search(filters) {
    ...
    // Exige um termo real. Busca apenas por UF retorna os primeiros registros
    // históricos da base e não representa uma busca confiável de leads.
    if (!query) {
      const error = new Error("Informe nome, número do registro ou especialidade.");
